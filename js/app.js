...
const i18n = {
  en: {
    ...
    mint_desc: 'Free mint your AgentIdentity NFT to unlock $TEVO minting and Four.meme Agent Token trading.',
    network: 'Network',
    holders: 'Holders',
    price: 'Price',
    free: 'FREE',
  ...
  zh: {
    ...
    mint_desc: '免费铸造你的 AgentIdentity NFT，解锁 $TEVO 铸造权限和 Four.meme Agent Token 交易权限。',
    network: '网络',
    holders: '持有者',
    price: '价格',
    free: '免费',
